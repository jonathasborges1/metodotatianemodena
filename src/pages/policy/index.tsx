            ...
            <Grid container gap={3}>
               ...
               <Grid item xs={12}>
                  <Typography variant="body1">
                     ...
                     <a
                        ...
                        target="_BLANK"
                        style={{ color: "#616060", textDecoration: "none" }} rel="noreferrer"
                     >
               ...
               <Grid item xs={12}>
                  ...
                  <p>
                     ...
                     você pode impedir que esses cookies sejam armazenados, no
                  ...
                  <ul>
                     <li >
                        <Typography variant="body1">
                           ...
                           , que é uma das soluções de análise mais difundidas e
                           confiáveis ​​da Web, para nos ajudar a entender como você
                           usa o site e como podemos melhorar sua experiência. Esses
                           cookies podem rastrear itens como quanto tempo você gasta
                  ...
                  <ul>
                     ...
                     <li>
                        <Typography variant="body1">
                           ...
                           Quando ainda estamos testando novos recursos, esses cookies
                           podem ser usados ​​para garantir que você receba uma
               ...
               <Grid item xs={12}>
                  ...
                  <Typography variant="body1">
                     ...
                     informação que o Tatiane Modena oferece no site e com caráter
                  ...
                  <ul>
                     ...
                     <li>
                        ...
                        (softwares) do Tatiane Modena, de seus fornecedores ou
               ...
               <Grid item xs={12}>
                  ...
                  <br />
                  <Typography variant="body1">
                     Esta política é efetiva a partir de <strong>Mar</strong>/
                     <strong>2023</strong>.
                  </Typography>
               </Grid>
